...
export default function AdminUsersClient() {
  ...
  // Panggil API, tanpa redirect login karena sudah di-handle oleh Server Component
  const fetchUsers = useCallback(async (page = 1) => {
    ...
    try {
      ...
      if (!res.ok) {
        // Hapus logika redirect login di sini. Cukup lempar error saja.
  ...
  // (JSX SAMA PERSIS SEPERTI KODE ASLI ANDA)
  return (
